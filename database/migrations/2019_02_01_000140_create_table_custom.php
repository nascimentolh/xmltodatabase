...
class CreateTableCustom extends Migration
{
    ...
    public function up()
    {
        Schema::create('custom_weapon_items', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::create('custom_armor_items', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('idItem');
            $table->string('type');
            $table->string('name');
        ...
        Schema::create('custom_etc_items', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('idItem');
            $table->string('type');
            $table->string('name');
